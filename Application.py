...
class Application(Frame):
	...
	def create_widgets(self):
		...
		self.scale1 = Scale(self, from_=0, to=100); self.scale1.grid(row=3, column=0, sticky=W)
		self.scale2 = Scale(self, from_=0, to=100); self.scale2.grid(row=3, column=0, sticky=W, padx=110)
		self.scale3 = Scale(self, from_=0, to=100); self.scale3.grid(row=3, column=0, sticky=W, padx=220)
		self.scale4 = Scale(self, from_=0, to=100); self.scale4.grid(row=3, column=0, sticky=W, padx=330)
		self.scale5 = Scale(self, from_=0, to=100); self.scale5.grid(row=3, column=0, sticky=W, padx=440)
	...
	def reveal(self):
		...
		handHeight 	= self.leap.listener.rightHandHeight
		...
		textContent = 'handheight : %s extended fingers: %s\n pitch : %s yaw : %s roll : %s' % (handHeight, rightFingers, rightPitch, rightYaw, rightRoll)
